...
class OfflinePageorg extends StatefulWidget {
  const OfflinePageorg({super.key});

  @override
  State<OfflinePageorg> createState() => _OfflinePageorgState();
}

class _OfflinePageorgState extends State<OfflinePageorg> {
          ...
          return ListView(
            children: snapshot.data!.docs.map((DocumentSnapshot document) {
              ...
              if (data['mode'] == 'OFFLINE') {
                ...
                // If the mode is not "online," return an empty container
